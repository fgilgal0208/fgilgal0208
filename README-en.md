# Hi, I'm Francisco Gilarte Galán 👋
...
* **[ReservasBarX](https://github.com/fgilgal0208/reservasbarx)**  
  *Comprehensive room reservation system. It includes a user authentication panel, full booking management in the database, and a specific feature to dynamically generate PDF summaries or receipts.*  
  `PHP` `Laravel` `Blade` `MySQL` `PDF Generation`
